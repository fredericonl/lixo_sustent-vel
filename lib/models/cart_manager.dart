...
import 'package:lixo_sustentavel/models/cart_product.dart';
...
import 'package:lixo_sustentavel/services/cepaberto_service.dart';

//Pode acessar o carrinho de qualquer lugar do programa
class CartManager extends ChangeNotifier {
  ...
  Future<void> _loadCartItems() async {
    //cartReference está em user.dart
  ...
  void removeOfCart(CartProduct cartProduct) {
    ...
    //remover listner quando deletado
